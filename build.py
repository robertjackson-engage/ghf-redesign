...
SOCIAL_PATHS = {
    # Brand marks, 24x24 viewBox (Simple Icons, CC0). Inline rather than image files so they
    # inherit currentColor and keep the circle's existing hover transition.
    "facebook": "M9.101 23.691v-7.98H6.627v-3.667h2.474v-1.58c0-4.085 1.848-5.978 5.858-5.978.401 "
    ...
    "instagram": "M12 0C8.74 0 8.333.015 7.053.072 5.775.132 4.905.333 4.14.63c-.789.306-1.459.717-2.126 "
                 ...
                 "2.16c3.203 0 3.585.016 4.85.071 1.17.055 1.805.249 2.227.415.562.217.96.477 "
                 ...
                 "3.678a6.162 6.162 0 1 0 0 12.324 6.162 6.162 0 0 0 0-12.324zM12 16a4 4 0 1 1 0-8 4 4 0 0 "
                 "1 0 8zm7.846-10.405a1.441 1.441 0 0 1-2.881 0 1.44 1.44 0 0 1 2.881 0z",
    ...
    "apple": "M12.152 6.896c-.948 0-2.415-1.078-3.96-1.04-2.04.027-3.91 1.183-4.961 3.014-2.117 "
             "3.675-.546 9.103 1.519 12.09 1.013 1.454 2.208 3.09 3.792 3.039 1.52-.065 "
             "2.09-.987 3.935-.987 1.831 0 2.35.987 3.96.948 1.637-.026 2.676-1.48 "
             "3.676-2.948 1.156-1.688 1.636-3.325 1.662-3.415-.039-.013-3.182-1.221-3.22-4.857-.026-3.04 "
    ...
    "googleplay": "M22.018 13.298l-3.919 2.218-3.515-3.493 3.543-3.521 3.891 2.202a1.49 1.49 0 0 1 0 "
                  "2.594zM1.337.924a1.486 1.486 0 0 0-.112.568v21.017c0 .217.045.419.124.6l11.155-11.087L1.337.924zm12.207 "
                  "10.065l3.258-3.238L3.45.195a1.466 1.466 0 0 0-.946-.179l11.04 10.973zm0 2.067l-11 "
                  "10.933c.298.036.612-.16.906-.183l13.324-7.54-3.23-3.21z",
}


def social_icon(name, cls="socials__icon"):
    """Brand glyph for a footer link. The surrounding <a> carries the accessible name, so the
    glyph itself is hidden from assistive tech and kept out of the tab order."""
    return (f'<svg class="{cls}" viewBox="0 0 24 24" fill="currentColor" '
            f'aria-hidden="true" focusable="false"><path d="{SOCIAL_PATHS[name]}"/></svg>')
  ...
  <div class="wrap">
    <div class="site-footer__top">
      <div class="site-footer__brand">
        ...
        <div class="socials">
          <a href="https://www.facebook.com/gainesvillefit" aria-label="Facebook">{social_icon("facebook")}</a>
          <a href="https://www.instagram.com/gainesvillehealth" aria-label="Instagram">{social_icon("instagram")}</a>
          <a href="https://www.youtube.com/user/GHFCadmin" aria-label="YouTube">{social_icon("youtube")}</a>
          <a href="https://www.linkedin.com/company/gainesville-health-&amp;-fitness" aria-label="LinkedIn">{social_icon("linkedin")}</a>
        </div>
        <div class="app-links">
          <h5>Get the GHF app</h5>
          <div class="app-links__row">
            <a href="https://apps.apple.com/us/app/gainesville-health-fitness/id441610875">
              {social_icon("apple", "app-links__icon")}<span><small>Download on the</small>App Store</span>
            </a>
            <a href="https://play.google.com/store/apps/details?id=com.bottegasol.com.migym.ghf&amp;hl=en_US">
              {social_icon("googleplay", "app-links__icon")}<span><small>Get it on</small>Google Play</span>
            </a>
          </div>
        </div>
      </div>
...
"""
    return hero(
        ...
        img=L["hero_img"],
        video=L.get("hero_video"),
        poster=L.get("hero_poster") or L["hero_img"],
        hero_cls=L.get("hero_cls", ""),
...
MAIN_CENTER = dict(
    ...
    hero_video="assets/video/ghf-main-tour-loop.mp4",
    hero_poster=f"{IMG}/hero-main-tour.jpg",
...
WOMENS_CENTER = dict(
    ...
    hero_video="assets/video/ghf-womens-tour-loop.mp4",
    hero_poster=f"{IMG}/hero-womens-tour.jpg",
    hero_cls="hero--cropb",
...
TIOGA_CENTER = dict(
    ...
    hero_video="assets/video/ghf-tioga-tour-loop.mp4",
    hero_poster=f"{IMG}/hero-tioga-tour.jpg",
    hero_cls="hero--cropb",
